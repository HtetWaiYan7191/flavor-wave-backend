...
restockDetails25 = RestockDetail.create([quantity: 30, expiry_date: 23/05/2023, restock_id: restock2, stock_id: stock2])
restockDetails26 = RestockDetail.create([quantity: 30, expiry_date: 23/05/2023, restock_id: restock1, stock_id: stock1])
restockDetails27 = RestockDetail.create([quantity: 30, expiry_date: 23/05/2023, restock_id: restock1, stock_id: stock8])
restockDetails28 = RestockDetail.create([quantity: 30, expiry_date: 23/05/2023, restock_id: restock2, stock_id: stock14])
