...
preorder10  = Preorder.create(client_id: client10.id, quantity: 117, order_date: "21/02/2023", order_status: 'delivered',    total: 20000, urgent: false, permission: false, user_id: User.first.id)  
...
preorder12  = Preorder.create(client_id: client12.id, quantity: 14,  order_date: "10/03/2023", order_status: 'delivered',    total: 40000, urgent: true,  permission: true, user_id: User.first.id)
