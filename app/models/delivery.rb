class Delivery < ApplicationRecord
  ...
  before_validation :reduce_truck_capacity, unless: -> { truck.nil? || !truck.available? }
  ...
  def reduce_truck_capacity
    ...
    return errors.add(:truck, 'capacity exceeded') if truck&.current_capacity.to_i < preorder.quantity
